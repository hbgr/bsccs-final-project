...
public class GemMachineBrain : MachineBrain
{
    ...
    // public IEnumerator MachineCoroutine(Machine machine, ScriptableArenaProperties arenaProps)
    // {
    ...
    //     Vector2 spawnPos = machine.transform.position + (Vector3)(2f * Random.Range(0.5f, 1.0f) * Random.insideUnitCircle.normalized);
